...
for epoch in range(1, args.epochs + 1):
    ...
    if epoch % 5 == 0:
        ...
        if valid_results[1][1] > best_recall:  # recall@20 as selection
            ...
            torch.save(
                model,
                "{}{}_{}lr1_{}lr2_{}wd1_{}wd2_bs{}_cate{}_in{}_out{}_lam{}_dims{}_emb{}_{}_steps{}_scale{}_min{}_max{}_sample{}_reweight{}_{}.pth".format(
                    save_path,
                    args.dataset,
                    args.lr1,
                    args.lr2,
            ...
            torch.save(
                Autoencoder,
                "{}{}_{}lr1_{}lr2_{}wd1_{}wd2_bs{}_cate{}_in{}_out{}_lam{}_dims{}_emb{}_{}_steps{}_scale{}_min{}_max{}_sample{}_reweight{}_{}_AE.pth".format(
                    save_path,
                    args.dataset,
                    args.lr1,
                    args.lr2,
